...
<div id="app-container" >
    <nav class="navbar fixed-top w-100">
        <router-link class="navbar-logo ml-2" tag="a" to="/app">
        ...
        <div class="d-flex navbar-right align-items-right justify-content-end">
            <div class="user d-inline-block">
                <b-dropdown class="dropdown-menu-right" right variant="empty" toggle-class="p-0" menu-class="mt-3" no-caret>
                    <template slot="button-content" v-if="currentUser">
                        ...
                        <span>
                            <img class="border border-primary rounded-circle" :alt="currentUser.username" :src="currentUser.photoURL" />
                        </span>
                    </template>
    ...
    <b-container fluid ref="welcomeView" class="welcomeView fixed">

        <b-row class="h-100">

          <!-- Profile Column -->

          <b-colxx class="col_profile" sm="12" xs="12" xl="10" lg="10">
            <b-row>
          ...
          <b-colxx class="col_advertise bg-light shadow" sm="12" xs="12" xl="2" lg="2">
            <div class="px-5 pt-5">

                <div class="row mt-3 justify-content-end align-items-center">
                  <h3 class="text-right">Candio</h3>
                </div>

                <div class="row mt-3 justify-content-end align-items-center">
                  <h3 class="text-right">The Future of Work is Remote</h3>
                </div>

                <div class="row py-3 px-3 mt-5 shadow-lg color-gray">
                  <span>Some Advertise : </span>
                  <span>Work full-time at U.S. companies.</span>
                </div>

                <div class="row py-3 px-3 mt-3 shadow-lg color-gray">
                  <p>Earn a better salary compared to local companies in your city.</p>
                </div>

                <div class="row py-3 px-3 mt-3 shadow-lg color-gray">
                  <p>Grow as a developer by working with the smartest engineers from all cover the world.</p>
                </div>

                <div class="row py-3 px-3 mt-3 shadow-lg color-gray">
                  <p>Get paid monthly directly for your bank account. Forgot about issues with PayPal or Payoneer</p>
                </div>

                <div class="ro my-3 border-bottom justify-content-center align-items-center">
                  <span class="side_logo"></span>
                </div>
