...
import {AuthRequired, IsAuthed } from "./utils/AuthService";
...
const routes = [
  ...
  {
    path: "/home",
    component: () => import(/* webpackChunkName: "error" */ "./views/home/home")
  },

  // Candidate
  {
    path: "/candidate",
    component: () => import(/* webpackChunkName: "app" */ "./views/candidate"),
    redirect: "/candidate/dashboards",
    beforeEnter: IsAuthed,
    children: [
      {
        path: "dashboards",
        component: () => import(/* webpackChunkName: "dashboards" */ "./views/candidate/dashboard")
      },
      {
        path: "profile",
        component: () => import(/* webpackChunkName: "dashboards" */ "./views/candidate/profile")
      },
      {
        path: "assessment",
        component: () => import(/* webpackChunkName: "dashboards" */ "./views/candidate/assessment")
      },
      {
        path: "challenge",
        component: () => import(/* webpackChunkName: "dashboards" */ "./views/candidate/challenge")
      },
      {
        path: "community",
        component: () => import(/* webpackChunkName: "dashboards" */ "./views/candidate/community")
      },
      {
        path: "report",
        component: () => import(/* webpackChunkName: "dashboards" */ "./views/candidate/report")
      },
      {
        path: "earn",
        component: () => import(/* webpackChunkName: "dashboards" */ "./views/candidate/earn")
      },
    ]
  },
  ...
  {
    path: "/company",
    component: () => import(/* webpackChunkName: "app" */ "./views/company"),
    redirect: "/company/dashboards",
    beforeEnter: IsAuthed,
    children: [
      {
        path: "dashboards",
      ...
      {
        path: "jobs/:jobId/candidates/listview",
        component: () => import("./views/company/job/jobCandidates"),
        props: true
      },
  ...
  },
  {
    ...
    children: [
...

      {
        path: "regcandidate",
        component: () =>
          import(/* webpackChunkName: "user" */ "./views/user/RegCandidate")
      },

      {
        path: "regcompany",
        component: () =>
          import(/* webpackChunkName: "user" */ "./views/user/RegCompany")
      },
